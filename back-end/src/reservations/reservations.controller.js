...
//   const validPeopleFormat = Number(people);

//   ///// compare inputs to validation standards
//   const validPeople = (validPeopleFormat > 0)
//   const validPhoneInput = mobile_number.match(validPhone);
//   const validDateInput = reservation_date.match(validDateFormat);
//   const validTimeInput = reservation_time.match(validTimeFormat);
...
//     return next({
//       status: 400,
//       message: "Error: Invalid reservation_date Input. Reservation must occur in the future",
//     })
//   }else if (!validTimeInput) {
//     return next({
//       status: 400,
//       message: "Error: Invalid reservation_time Input",
//     })
//   } else if (!validPeople) {
//     return next({
//       status: 400,
//       message: "Error: Invalid people input",
//     })
//   }
...
//   if (validPeople && validDateInput && validTimeInput) {
//       return next();
//   } else {
//     next({
//       status: 400,
